...
| REQ-006 | CONOPS-005 | Label answer source class and confidence once non-seed historical data is introduced. | SPEC-006 source/confidence fields | IF-007, IF-008, IF-009, IF-010, IF-011 | CR-003 no restricted-source copying | WP-005 / WP-006 | `SourceClass`, seed-labeled query envelopes, source-custody package, first real fact fixture, materializer, and query | review / inspection | source-review scenario | first source-backed fixture facts, materialized title, and source-backed query verified on 2026-06-19 | verified first import |
