...
| REQ-006 | CONOPS-005 | Label answer source class and confidence once non-seed historical data is introduced. | SPEC-006 source/confidence fields | IF-007, IF-008 | CR-003 no restricted-source copying | WP-005 / deferred source package | `SourceClass`, seed-labeled query envelopes, future source schema | review / inspection | source-review scenario | seed source class verified; real source confidence deferred to WP-006 | partially verified |
