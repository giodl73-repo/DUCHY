...
| REQ-006 | CONOPS-005 | Label answer source class and confidence once non-seed historical data is introduced. | SPEC-006 source/confidence fields | IF-007, IF-008, IF-009 | CR-003 no restricted-source copying | WP-005 / WP-006 | `SourceClass`, seed-labeled query envelopes, source-custody package, first real title materializer | review / inspection | source-review scenario | first source-backed facts and materialized title verified on 2026-06-19 | verified first import |
