...
| REQ-006 | CONOPS-005 | Label answer source class and confidence once non-seed historical data is introduced. | SPEC-006 source/confidence fields | IF-007, IF-008 | CR-003 no restricted-source copying | WP-005 / WP-006 | `SourceClass`, seed-labeled query envelopes, source-custody package | review / inspection | source-review scenario | seed source class verified; source-custody policy accepted; real imports still require per-source gate | verified for policy |
