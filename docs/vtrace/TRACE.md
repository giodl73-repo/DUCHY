...
| REQ-003 | CONOPS-001 | Answer higher-title path for a year. | SPEC-003 yearly title-path query | IF-002 | CR-002 traceable answer shape | WP-002 | `title_path_in_year`, fixtures | test / demonstration | designer asks county-in-year question | pending | accepted |
| REQ-004 | CONOPS-002 | Answer transfers between duchies over a range. | SPEC-004 range transfer query | IF-003 | CR-002 | WP-003 | `transfers_between`, transfer fixtures | test / demonstration | designer asks moved-between-duchies question | pending | accepted |
| REQ-005 | CONOPS-003 | Expose ordered continuity events. | SPEC-005 lineage event query | IF-004 | CR-001 | WP-002 | `events_for_title`, future lineage answer | test / inspection | title-lineage scenario | current `events_for_title`; future answer trace | partially implemented |
| REQ-006 | CONOPS-005 | Label source class and confidence for historical data. | SPEC-006 source/confidence fields | IF-005, IF-006 | CR-003 no restricted-source copying | deferred source package | docs/source plan, future fixture schema | review / inspection | source-review scenario | pending | proposed |
| REQ-007 | CONOPS-005 | Distinguish empty, unsupported, unknown, and contested answers. | SPEC-007 answer status taxonomy | IF-005 | CR-002 | WP-004 | answer trace object, negative fixtures | test | negative-answer scenario | pending | accepted |
...
| CR-002 | Query answers must expose enough trace to diagnose why the answer was returned. | IF-002 through IF-005. | Tests and role review. |
