...
| 181 additional candidate sources remain staged and pending. | The repo has 500 unique sources in the review universe, not 500 accepted source-backed facts. | The promotable title-identity subset is exhausted except fourteen deferred date-problem rows; keep contested and relation-heavy rows in review. |
