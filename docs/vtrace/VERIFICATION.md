...
| Fourteen additional candidate sources remain staged and pending. | The repo has 500 unique sources in the review universe, not 500 accepted source-backed facts. | The active remainder is limited to deferred date-problem title rows; 167 unsupported or relation-heavy rows are archived as `scope_deferred`. |
