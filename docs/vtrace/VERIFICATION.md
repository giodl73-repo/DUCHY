...
| Sixty-eight concrete source records have passed the gate, but most source-backed titles still have no reviewed parentage. | Historical identity coverage is broader than hierarchy coverage. | Expand parentage through reviewed relation packets only. |
| 432 additional candidate sources remain staged and pending. | The repo has 500 unique sources in the review universe, not 500 accepted source-backed facts. | Promote only reviewed title-identity subsets through the staging gate. |
