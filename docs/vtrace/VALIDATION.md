...
|---|---|---|---|---|---|---|
| VAL-001 | Game designer | Find which duchy contains a county in a year. | Ask title-path query for county C in year Y. | Answer returns county and duchy, plus higher titles where known. | WP-003 fixture/demo | pending |
| VAL-002 | Game designer | Find areas that moved between duchies. | Ask transfer query for area/title over date range. | Answer lists ordered transfers with from/to titles and dates. | WP-004 fixture/demo | pending |
| VAL-003 | World builder | Explain title lineage. | Ask lineage query for title T. | Answer shows continuity events and relevant parent/control changes. | WP-003 fixture/demo | pending |
