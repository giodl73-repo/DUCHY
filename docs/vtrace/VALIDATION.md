...
|---|---|---|---|---|---|---|
| VAL-001 | Game designer | Find which duchy contains a county in a year. | Ask title-path query for county C in year Y. | Answer returns county and duchy, plus higher titles where known. | WP-002 fixture/demo | pending |
| VAL-002 | Game designer | Find areas that moved between duchies. | Ask transfer query for area/title over date range. | Answer lists ordered transfers with from/to titles and dates. | WP-003 fixture/demo | pending |
| VAL-003 | World builder | Explain title lineage. | Ask lineage query for title T. | Answer shows continuity events and relevant parent/control changes. | WP-002 fixture/demo | pending |
| VAL-004 | Campaign author | Separate control from legal claim. | Ask holder and de jure parent question for title/year. | Answer shows de facto holder separately from de jure parent path. | WP-002 fixture/demo | pending |
| VAL-005 | Source reviewer | Know whether answer is source-backed. | Inspect answer trace for fixture/source class. | Historical data has source/confidence labels; seed data is labeled seed. | WP-004/source package | deferred |
