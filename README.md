...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 348 reviewed source records.
...
accepted fixture set to 348 reviewed sources and 1190 reviewed facts. Title
...
Westphalia and French Empire, and Prince-Bishopric of Augsburg HRE packets,
raising reviewed real parentage coverage to 194 facts.
