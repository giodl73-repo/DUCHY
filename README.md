...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 352 reviewed source records.
...
accepted fixture set to 352 reviewed sources and 1196 reviewed facts. Title
...
Imereti Russian Empire, Italian protectorate of Albania Italian Empire, and
Francia Carolingian Empire packets, raising reviewed real parentage coverage to
197 facts.
