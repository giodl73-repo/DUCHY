...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 346 reviewed source records.
...
accepted fixture set to 346 reviewed sources and 1188 reviewed facts. Title
...
Rhine Westphalia packets, raising reviewed real parentage coverage to 192
facts.
