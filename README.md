...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 362 reviewed source records.
...
accepted fixture set to 362 reviewed sources and 1210 reviewed facts. Title
...
HRE packet, raising reviewed real parentage coverage to 205 facts.
