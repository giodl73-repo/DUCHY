...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 361 reviewed source records.
...
accepted fixture set to 361 reviewed sources and 1209 reviewed facts. Title
...
County of Astarac Duchy of Gascony packets, raising reviewed real parentage
coverage to 204 facts.
