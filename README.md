...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 340 reviewed Wikidata structured
  claim sources.
...
accepted fixture set to 340 reviewed sources and 1171 reviewed facts. Title
...
packets, followed by the Schleswig Denmark packet, raising reviewed real
parentage coverage to 184 facts.
