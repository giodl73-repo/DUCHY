...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 363 reviewed source records.
...
accepted fixture set to 363 reviewed sources and 1211 reviewed facts. Title
...
HRE and Duchy of Florence HRE packets, raising reviewed real parentage coverage
to 206 facts.
