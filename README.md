...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 364 reviewed source records.
...
accepted fixture set to 364 reviewed sources and 1212 reviewed facts. Title
...
raising reviewed real parentage coverage to 207 facts.
