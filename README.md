...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 353 reviewed source records.
...
accepted fixture set to 353 reviewed sources and 1197 reviewed facts. Title
...
Carolingian Empire, and Duchy of Prussia Polish Crown packets, raising reviewed
real parentage coverage to 198 facts.
