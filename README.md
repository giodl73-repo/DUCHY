...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 393 reviewed source records.
...
accepted fixture set to 393 reviewed sources and 1242 reviewed facts. Title
...
Horde parentage, raising reviewed real parentage coverage to 237 facts.
