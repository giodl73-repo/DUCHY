...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 359 reviewed source records.
...
accepted fixture set to 359 reviewed sources and 1205 reviewed facts. Title
...
of Naples Crown of Aragon, and Grand Principality of Moscow Golden Horde
packets, raising reviewed real parentage coverage to 203 facts.
