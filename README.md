...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 345 reviewed source records.
...
accepted fixture set to 345 reviewed sources and 1184 reviewed facts. Title
...
County of Savoy HRE, and Duchy of Warsaw French Empire packets, raising
reviewed real parentage coverage to 191 facts.
