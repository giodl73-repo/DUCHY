...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 357 reviewed source records.
...
accepted fixture set to 357 reviewed sources and 1201 reviewed facts. Title
...
Aragon, Grand Duchy of Tuscany HRE, Duchy of Parma and Piacenza Empire, and
Kingdom of Naples Crown of Aragon packets, raising reviewed real parentage
coverage to 202 facts.
