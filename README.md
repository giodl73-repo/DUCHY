...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 367 reviewed source records.
...
accepted fixture set to 373 reviewed sources and 1221 reviewed facts. Title
...
Duchy of Austria HRE, Duchy of Athens Thessalonica, and Kingdom of Thessalonica
Latin Empire packets, raising reviewed real parentage coverage to 216 facts.
