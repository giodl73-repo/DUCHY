...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 354 reviewed source records.
...
accepted fixture set to 354 reviewed sources and 1198 reviewed facts. Title
...
Carolingian Empire, Duchy of Prussia Polish Crown, and County of Empuries Crown
of Aragon packets, raising reviewed real parentage coverage to 199 facts.
