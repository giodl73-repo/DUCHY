...
- `docs/vtrace/source-custody/` defines the gate for real historical sources.
  The accepted fixture catalog now contains 347 reviewed source records.
...
accepted fixture set to 347 reviewed sources and 1189 reviewed facts. Title
...
County of Savoy HRE, Duchy of Warsaw French Empire, and Confederation of the
Rhine Westphalia and French Empire packets, raising reviewed real parentage
coverage to 193 facts.
