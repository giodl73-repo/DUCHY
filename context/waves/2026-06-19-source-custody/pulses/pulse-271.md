# Pulse 271 - Sicily Crown of Aragon Relation

## Scope

Promoted `sicily-crown-aragon-relation-01`, adding relation context for the
accepted Kingdom of Sicily parentage under the Crown of Aragon.

## Accepted Inputs

- `data/staging/sicily-crown-aragon-relation-01.sources`
- `data/staging/sicily-crown-aragon-relation-01.facts`
...
- Raised accepted facts to 1630.
- Raised relation facts to 262.
...
- `cargo run --quiet --bin duchy-promote -- --dry-run --report data/staging/sicily-crown-aragon-relation-01-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/sicily-crown-aragon-relation-01.sources data/staging/sicily-crown-aragon-relation-01.facts`
- `cargo run --quiet --bin duchy-promote -- --apply --report data/staging/sicily-crown-aragon-relation-01-apply-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/sicily-crown-aragon-relation-01.sources data/staging/sicily-crown-aragon-relation-01.facts`
