# Pulse 269 - Normandy France Relation

## Scope

Promoted `normandy-france-relation-01`, adding relation context for the
accepted Duchy of Normandy parentage under the Kingdom of France.

## Accepted Inputs

- `data/staging/normandy-france-relation-01.sources`
- `data/staging/normandy-france-relation-01.facts`
...
- Raised accepted facts to 1625.
- Raised relation facts to 257.
...
- `cargo run --quiet --bin duchy-promote -- --dry-run --report data/staging/normandy-france-relation-01-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/normandy-france-relation-01.sources data/staging/normandy-france-relation-01.facts`
- `cargo run --quiet --bin duchy-promote -- --apply --report data/staging/normandy-france-relation-01-apply-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/normandy-france-relation-01.sources data/staging/normandy-france-relation-01.facts`
