# Pulse 272 - Naples Crown of Aragon Relation

## Scope

Promoted `naples-crown-aragon-relation-01`, adding relation context for the
accepted Kingdom of Naples parentage under the Crown of Aragon.

## Accepted Inputs

- `data/staging/naples-crown-aragon-relation-01.sources`
- `data/staging/naples-crown-aragon-relation-01.facts`
...
- Raised accepted facts to 1631.
- Raised relation facts to 263.
...
- `cargo run --quiet --bin duchy-promote -- --dry-run --report data/staging/naples-crown-aragon-relation-01-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/naples-crown-aragon-relation-01.sources data/staging/naples-crown-aragon-relation-01.facts`
- `cargo run --quiet --bin duchy-promote -- --apply --report data/staging/naples-crown-aragon-relation-01-apply-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/naples-crown-aragon-relation-01.sources data/staging/naples-crown-aragon-relation-01.facts`
