# Pulse 268 - Athens Thessalonica Relation

## Scope

Promoted `athens-thessalonica-relation-01`, adding relation context for the
accepted Duchy of Athens parentage under the Kingdom of Thessalonica.

## Accepted Inputs

- `data/staging/athens-thessalonica-relation-01.sources`
- `data/staging/athens-thessalonica-relation-01.facts`
...
- Raised accepted facts to 1624.
- Raised relation facts to 256.
...
- `cargo run --quiet --bin duchy-promote -- --dry-run --report data/staging/athens-thessalonica-relation-01-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/athens-thessalonica-relation-01.sources data/staging/athens-thessalonica-relation-01.facts`
- `cargo run --quiet --bin duchy-promote -- --apply --report data/staging/athens-thessalonica-relation-01-apply-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/athens-thessalonica-relation-01.sources data/staging/athens-thessalonica-relation-01.facts`
