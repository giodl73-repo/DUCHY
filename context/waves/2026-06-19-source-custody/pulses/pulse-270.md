# Pulse 270 - Bohemian Silesian Vassal Relations

## Scope

Promoted `bohemian-silesian-vassal-relation-01`, adding relation context for
four accepted Bohemian Silesian duchy parentage rows.

## Accepted Inputs

- `data/staging/bohemian-silesian-vassal-relation-01.sources`
- `data/staging/bohemian-silesian-vassal-relation-01.facts`
...
- Raised accepted facts to 1629.
- Raised relation facts to 261.
...
- `cargo run --quiet --bin duchy-promote -- --dry-run --report data/staging/bohemian-silesian-vassal-relation-01-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/bohemian-silesian-vassal-relation-01.sources data/staging/bohemian-silesian-vassal-relation-01.facts`
- `cargo run --quiet --bin duchy-promote -- --apply --report data/staging/bohemian-silesian-vassal-relation-01-apply-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/bohemian-silesian-vassal-relation-01.sources data/staging/bohemian-silesian-vassal-relation-01.facts`
