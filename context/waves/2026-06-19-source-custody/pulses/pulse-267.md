# Pulse 267 - Rhine Confederation French Empire Relation

## Scope

Promoted `rhine-confederation-french-empire-relation-01`, adding relation
context for the accepted Confederation of the Rhine parentage under the First
French Empire.

## Accepted Inputs

- `data/staging/rhine-confederation-french-empire-relation-01.sources`
- `data/staging/rhine-confederation-french-empire-relation-01.facts`
...
- Raised accepted facts to 1623.
- Raised relation facts to 255.
...
- `cargo run --quiet --bin duchy-promote -- --dry-run --report data/staging/rhine-confederation-french-empire-relation-01-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/rhine-confederation-french-empire-relation-01.sources data/staging/rhine-confederation-french-empire-relation-01.facts`
- `cargo run --quiet --bin duchy-promote -- --apply --report data/staging/rhine-confederation-french-empire-relation-01-apply-report.md fixtures/first-real.sources fixtures/first-real.facts data/staging/rhine-confederation-french-empire-relation-01.sources data/staging/rhine-confederation-french-empire-relation-01.facts`
